 ...
 * @e_ident: A specific pointer to an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
	printf("  Data:                              ");
 ...
 * @e_ident: A certain pointer to an array containing the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
...
/**
 * print_abi - this function (qw23) prints the ABI version of an ELF header.
 ...
 *
 * Description: if the specfic File cannot be closed - exit code will be 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
...
/**
*main- It displays the Information contained in the specific
*ELF header at the Start of an ELF file.
* @argc: the Specific number of arguments supplied to the program.
